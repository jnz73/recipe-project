...
import it.gianni.recipeproject.converters.UnitOfMeasureToUnitOfMeasureCommand;
...
public class UnitOfMeasureServiceImpl implements UnitOfMeasureService {
    ...
    public Set<UnitOfMeasureCommand> listAllUoms() {
        return StreamSupport.stream(unitOfMeasureRepository.findAll().spliterator(), false).map
